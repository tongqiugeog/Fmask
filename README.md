...
**autoFmask** is the main function for processing a image. **autoFmaskBacth** can process all Landsats 4-8 and Sentinel-2 images into a folder.
...
**IMPORTANT:** When making the accuracy assessment for Fmask, please dilate 3 pixels for cloud shadow pixels, but no dilation for cloud, snow, and water pixels.
