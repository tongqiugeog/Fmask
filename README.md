...
**autoFmask** is the main function for processing one certain image. **autoFmaskBacth** can process all Landsats 4-8 and Sentinel-2 images into a certain folder.
